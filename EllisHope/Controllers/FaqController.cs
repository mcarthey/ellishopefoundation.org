...
[ApiExplorerSettings(GroupName = "FAQ")]
[SwaggerTag("Frequently Asked Questions and help resources. Public-facing page answering common questions about the Ellis Hope Foundation, programs, application process, and how to get involved.")]
public class FaqController : Controller
{
    // GET: Faq
    /// <summary>
    /// Displays the Frequently Asked Questions page with categorized Q&A sections
    /// </summary>
    ...
    /// - Expandable/collapsible accordion-style Q&A sections
    ...
    /// - Donations & Fundraising (how to donate, tax deductions)
